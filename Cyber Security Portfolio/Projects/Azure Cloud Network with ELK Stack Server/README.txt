...
•	Ansible YML FIles/web_vm_docker_setup.yml
•	Ansible YML FIles/elk_server_setup.yml
•	Ansible YML FIles/filebeat_setup.yml
•	Ansible YML FIles/metricbeat_setup.yml
...
•	Run the playbook, and check that the installation worked as expected.
	o	If running web_vm_docker_setup.yml:
	...
	o	If running elk_server_setup.yml:
		•	Ensure security group rules allow SSH connection from Jump-Box-Provisioner internal IP address
	...
	o	If running filebeat_setup.yml:
	...
	o	If running metricbeat_setup.yml:
